...
import { createOneQuestion, getTrainingTypes, getTypeCategory, getTypeLevels } from '../../features/questions/questionSlice';
...
const AddQuestion = () => {
  ...
  if (addOne && addOne.status === 200) {
    toast.success("تمت اضافة سؤال بنجاح")
  } else if(addOne && addOne.message === 'Request failed with status code 422'){
    toast.error("حدث خطأ في الاضافة")
