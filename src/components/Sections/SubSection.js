...
const SubSection = () => {
    ...
    <div style={{paddingRight:'30px', paddingLeft:'30px' , height:'100%'}}>
            ...
            <div style={{ display:'flex', justifyContent:'space-between', marginLeft:'25px', marginRight:'25px'}}>
                ...
                <div>
                <p style={{ display:'flex', fontSize:'18px', marginBottom:'25px'}}> الاقسام الفرعية   </p>
                 
                </div>

                <div style={{display:'flex', alignItems:'center', gap:'15px'}}>
            <Link to='/add-sub-section'>
...
<Modal
      ...
      >
        ...
        <div style={{display:'flex', flexDirection:'column', justifyContent:'center', alignItems:'center', textAlign:'center'}}>
          ...
          <span style={{color:'#FF8410'}}> الاقسام الفرعيه  </span> </p>
